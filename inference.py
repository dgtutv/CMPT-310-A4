...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        NDProbability = busters.getObservationProbability(noisyDistance, trueDistance)
        return NDProbability
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        density = self.numParticles // numLegalPos
        remainder = self.numParticles % numLegalPos
    ...
    def observeUpdate(self, observation, gameState):
        ...
        # Updated weights no longer sum to zero, normalize before sampling
        weights.normalize()
    ...
    def getBeliefDistribution(self):
        ...
        beliefDist = DiscreteDistribution(counts)
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        # Shuffle to ensure uniform random order
        ...
        # Repeat to get numParticles particles
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                noisyObs = observation[i]
                prob = self.getObservationProb(noisyObs, pacmanPos, ghostPos, jailPos)
                weight *= prob
